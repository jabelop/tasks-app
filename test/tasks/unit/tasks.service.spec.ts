...
const tasksRepositoryProvider = { provide: TasksRepository, useClass: TasksTestRepository };
describe('TasksService', () => {
  ...
  it('should get all existing tasks for an exisiting userId', async () => {
    expect((await service.findAllForUserId('78146de0-5fbf-40f8-b11c-08975c7204da')))
      .toMatchObject([
        {
